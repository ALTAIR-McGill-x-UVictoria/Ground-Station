...
class lora(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.osmosdr_source_0.set_center_freq((438*10**6), 0)
        ...
        self.lora_rx_0 = lora_sdr.lora_sdr_lora_rx( bw=62500, cr=8, has_crc=True, impl_head=False, pay_len=255, samp_rate=int(samp_rate), sf=12, sync_word=[0x12], soft_decoding=True, ldro_mode=2, print_rx=[True,True])
